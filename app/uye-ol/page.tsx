...
function UyeOlContent() {
  ...
  const redirectTo = searchParams.get("redirect") || "/giris-yap";
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      console.error("REGISTER_PAGE_ERROR", err);
      setError("Üyelik sırasında bir hata oluştu.");
    } finally {
      setLoading(false);
    }
  }
    ...
    <main className="min-h-screen bg-[#06131d] px-4 py-12 text-white">
      <div className="mx-auto max-w-md">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl">
          <h1 className="text-4xl font-extrabold">Üye Ol</h1>

          <p className="mt-3 text-slate-400">
            Ücretsiz hesap oluştur ve hemen ilan vermeye başla.
          </p>
